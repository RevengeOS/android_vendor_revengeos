...
# Set all versions
CITRUS_VERSION := CitrusCAF-$(PRODUCT_VERSION_MAINTENANCE)-$(PRODUCT_VERSION_FLAVOUR)-$(PRODUCT_VERSION_MAJOR)-$(CITRUS_BUILD_TYPE)$(CITRUS_POSTFIX)
CITRUS_MOD_VERSION := CitrusCAF-$(CITRUS_BUILD)-$(PRODUCT_VERSION_MAINTENANCE)-$(CITRUS_BUILD_TYPE)$(CITRUS_POSTFIX)
PRODUCT_PROPERTY_OVERRIDES += \
